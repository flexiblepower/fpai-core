...
import org.flexiblepower.efi.unconstrained.UnconstrainedStateUpdate.TimerUpdate;
...
public class UnconstrainedStateUpdate extends UnconstrainedUpdate{
	...
	public UnconstrainedStateUpdate(String resourceId, Date timestamp,
			Date validFrom, Measurable<Duration> allocationDelay,
			int currentRunningModeId, Set<TimerUpdate> timerUpdates) {
